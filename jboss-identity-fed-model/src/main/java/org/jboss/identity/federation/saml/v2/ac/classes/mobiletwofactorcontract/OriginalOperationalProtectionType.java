 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorContract}SecurityAudit" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorContract}DeactivationCallCenter" minOccurs="0"/>
...
@XmlSeeAlso({
    OperationalProtectionType.class
})
public class OriginalOperationalProtectionType {
