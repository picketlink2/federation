 ...
 * generated in the oasis.names.tc.saml._2_0.ac.classes.softwarepki package. 
...
public class ObjectFactory {
    ...
    private final static QName _Extension_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Extension");
    private final static QName _OperationalProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "OperationalProtection");
    private final static QName _DeactivationCallCenter_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "DeactivationCallCenter");
    private final static QName _ComplexAuthenticator_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ComplexAuthenticator");
    private final static QName _PrivateKeyProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "PrivateKeyProtection");
    private final static QName _SecretKeyProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SecretKeyProtection");
    private final static QName _AuthnMethod_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "AuthnMethod");
    private final static QName _DigSig_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "DigSig");
    private final static QName _ADSL_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ADSL");
    private final static QName _SwitchAudit_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SwitchAudit");
    private final static QName _ActivationLimit_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ActivationLimit");
    private final static QName _KeyActivation_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "KeyActivation");
    private final static QName _WrittenConsent_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "WrittenConsent");
    private final static QName _GoverningAgreementRef_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "GoverningAgreementRef");
    private final static QName _Password_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Password");
    private final static QName _ActivationLimitUsages_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ActivationLimitUsages");
    private final static QName _WTLS_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "WTLS");
    private final static QName _ActivationLimitSession_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ActivationLimitSession");
    private final static QName _IPAddress_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "IPAddress");
    private final static QName _TechnicalProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "TechnicalProtection");
    private final static QName _KeySharing_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "KeySharing");
    private final static QName _Alphabet_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Alphabet");
    private final static QName _KeyStorage_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "KeyStorage");
    private final static QName _ZeroKnowledge_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ZeroKnowledge");
    private final static QName _SharedSecretChallengeResponse_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SharedSecretChallengeResponse");
    private final static QName _UserSuffix_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "UserSuffix");
    private final static QName _AsymmetricKeyAgreement_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "AsymmetricKeyAgreement");
    private final static QName _GoverningAgreements_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "GoverningAgreements");
    private final static QName _SSL_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SSL");
    private final static QName _HTTP_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "HTTP");
    private final static QName _PrincipalAuthenticationMechanism_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "PrincipalAuthenticationMechanism");
    private final static QName _SharedSecretDynamicPlaintext_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SharedSecretDynamicPlaintext");
    private final static QName _PreviousSession_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "PreviousSession");
    private final static QName _Smartcard_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Smartcard");
    private final static QName _Identification_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Identification");
    private final static QName _SubscriberLineNumber_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SubscriberLineNumber");
    private final static QName _AuthenticationContextDeclaration_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "AuthenticationContextDeclaration");
    private final static QName _ResumeSession_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ResumeSession");
    private final static QName _Token_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Token");
    private final static QName _MobileNetworkEndToEndEncryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "MobileNetworkEndToEndEncryption");
    private final static QName _AsymmetricDecryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "AsymmetricDecryption");
    private final static QName _ActivationLimitDuration_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ActivationLimitDuration");
    private final static QName _PSTN_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "PSTN");
    private final static QName _SecurityAudit_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "SecurityAudit");
    private final static QName _Length_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Length");
    private final static QName _Authenticator_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "Authenticator");
    private final static QName _IPSec_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "IPSec");
    private final static QName _ActivationPin_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ActivationPin");
    private final static QName _ISDN_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "ISDN");
    private final static QName _MobileNetworkRadioEncryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "MobileNetworkRadioEncryption");
    private final static QName _MobileNetworkNoEncryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "MobileNetworkNoEncryption");
    private final static QName _RestrictedPassword_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "RestrictedPassword");
    private final static QName _TimeSyncToken_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "TimeSyncToken");
    private final static QName _AuthenticatorTransportProtocol_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI", "AuthenticatorTransportProtocol");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: oasis.names.tc.saml._2_0.ac.classes.softwarepki
     * 
     */
