 ...
 * generated in the oasis.names.tc.saml._2_0.ac.classes.mobiletwofactorunregistered package. 
...
public class ObjectFactory {
    ...
    private final static QName _ComplexAuthenticator_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ComplexAuthenticator");
    private final static QName _Authenticator_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Authenticator");
    private final static QName _SharedSecretChallengeResponse_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SharedSecretChallengeResponse");
    private final static QName _AsymmetricDecryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "AsymmetricDecryption");
    private final static QName _GoverningAgreements_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "GoverningAgreements");
    private final static QName _Length_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Length");
    private final static QName _PrivateKeyProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "PrivateKeyProtection");
    private final static QName _AuthenticationContextDeclaration_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "AuthenticationContextDeclaration");
    private final static QName _MobileNetworkEndToEndEncryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "MobileNetworkEndToEndEncryption");
    private final static QName _ResumeSession_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ResumeSession");
    private final static QName _SwitchAudit_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SwitchAudit");
    private final static QName _HTTP_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "HTTP");
    private final static QName _MobileNetworkRadioEncryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "MobileNetworkRadioEncryption");
    private final static QName _Password_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Password");
    private final static QName _DeactivationCallCenter_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "DeactivationCallCenter");
    private final static QName _SecretKeyProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SecretKeyProtection");
    private final static QName _PrincipalAuthenticationMechanism_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "PrincipalAuthenticationMechanism");
    private final static QName _AsymmetricKeyAgreement_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "AsymmetricKeyAgreement");
    private final static QName _KeySharing_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "KeySharing");
    private final static QName _ActivationPin_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ActivationPin");
    private final static QName _GoverningAgreementRef_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "GoverningAgreementRef");
    private final static QName _KeyActivation_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "KeyActivation");
    private final static QName _TechnicalProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "TechnicalProtection");
    private final static QName _ActivationLimit_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ActivationLimit");
    private final static QName _AuthnMethod_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "AuthnMethod");
    private final static QName _Token_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Token");
    private final static QName _IPSec_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "IPSec");
    private final static QName _SSL_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SSL");
    private final static QName _ZeroKnowledge_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ZeroKnowledge");
    private final static QName _ActivationLimitUsages_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ActivationLimitUsages");
    private final static QName _IPAddress_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "IPAddress");
    private final static QName _TimeSyncToken_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "TimeSyncToken");
    private final static QName _KeyStorage_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "KeyStorage");
    private final static QName _UserSuffix_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "UserSuffix");
    private final static QName _PreviousSession_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "PreviousSession");
    private final static QName _MobileNetworkNoEncryption_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "MobileNetworkNoEncryption");
    private final static QName _DigSig_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "DigSig");
    private final static QName _Alphabet_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Alphabet");
    private final static QName _SecurityAudit_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SecurityAudit");
    private final static QName _Extension_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Extension");
    private final static QName _PSTN_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "PSTN");
    private final static QName _ActivationLimitSession_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ActivationLimitSession");
    private final static QName _AuthenticatorTransportProtocol_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "AuthenticatorTransportProtocol");
    private final static QName _SharedSecretDynamicPlaintext_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SharedSecretDynamicPlaintext");
    private final static QName _ISDN_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ISDN");
    private final static QName _OperationalProtection_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "OperationalProtection");
    private final static QName _WTLS_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "WTLS");
    private final static QName _Identification_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Identification");
    private final static QName _RestrictedPassword_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "RestrictedPassword");
    private final static QName _Smartcard_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "Smartcard");
    private final static QName _WrittenConsent_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "WrittenConsent");
    private final static QName _ADSL_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ADSL");
    private final static QName _ActivationLimitDuration_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "ActivationLimitDuration");
    private final static QName _SubscriberLineNumber_QNAME = new QName("urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered", "SubscriberLineNumber");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: oasis.names.tc.saml._2_0.ac.classes.mobiletwofactorunregistered
     * 
     */
